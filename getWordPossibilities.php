<?php
	...
	$code_polices['coupable_haut_maj'] 	= array(array('A'),array('A'),array('A','C'),array('A'),array('A','C'),array('C'),array('A','C'),array('II'),array('I'),array('I','T'),array('II'),array('I'),array('M'),array('A','II'),array('A'),array('A'),array('A'),array('A'),array('A','C'),array('T'),array('II'),array('II'),array('III'),array('II'),array('II'),array('Z'));
	...
	function getCodeWords($code, $police)
	{
		$taille = strlen($code);
		$code_2 = substr($code, 0, 2);
		
		$url = 'local_db/' . $police . '/' . $taille . '/' . $code_2 . '.php';
